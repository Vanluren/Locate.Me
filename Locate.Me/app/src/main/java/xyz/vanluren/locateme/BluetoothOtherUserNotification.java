...
/**
 * Helper class for showing and canceling bluetooth other user
 * notifications.
 * <p>
 * This class makes heavy use of the {@link NotificationCompat.Builder} helper
 * class to create notifications in a backward-compatible way.
 */
public class BluetoothOtherUserNotification {
    /**
     ...
     * presentation of bluetooth other user notifications. Make
     * sure to follow the
    ...
    public static void notify(final Context context,
        ...
        final NotificationCompat.Builder builder = new NotificationCompat.Builder(context)
                ...
                .setSmallIcon(R.drawable.ic_stat_bluetooth_other_user)
